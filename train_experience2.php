...
<head>
    ...
    <style>
        .center__homepage--content {
            background-image: url('./image/Background__img/search_page/Picture4.png');
    ...
    <div class="metro_home--page">
        ...
        <div class="header__page--wrap">
            <div class="metro_Logo">
                <a href=""><img src="./image/Logo/Logo.png" alt="HCHC"></a>
            </div>
            ...
            <div class="menu">
                ...
                <a href="./search.php"><img class="img__wrap--nav" src="./image/Icon/menu_Icon/search.png" alt=""> TRA
                    CỨU</a>
                <a href="./action.phpsearch.php"><img class="img__wrap--nav" src="./image/Icon/menu_Icon/work.png" alt=""> HOẠT
                    ĐỘNG</a>
                <a href="./support.phpsearch.php"><img class="img__wrap--nav" src="./image/Icon/menu_Icon/contact.png" alt=""> HỖ
                    TRỢ</a>
            </div>
